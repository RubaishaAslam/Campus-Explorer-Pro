 ...
 * @author Otis Ding
 * 
 * This class represents the popup that appears once a POI is clicked. It contains information of the POI as well as the option to edit such information
 */
public class popup extends javax.swing.JFrame {
    ...
    * @param label The JLabel that represents the POI
    */
    
    /**
     * Constructor - Creates the JFrame that represents the POI popup, inputs the previously saved information, and sets the visibility of the buttons based on the user type
     * @return void
     */
    ...
    /**
     * Action event for when the "Save" button is clicked, this will save the changes made to the POI and store them into the backend
    ...
    /**
     * Action event for when the "Layers" button is clicked, this will open the EditLayers_Popup
     * @param evt the action event
     * @return void
     */
    ...
    /**
     * Action event for when the "Delete" button is clicked, this will delete the POI from the backend as well as from the GUI
     * @param evt the action event
     * @return void
     */
